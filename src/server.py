...
def main():
    ...
    while True:
        ...
        try:
            ...
            client_prime_module = connection.recv(128).decode(encoding='latin-1')
            ...
            client_result = connection.recv(128).decode(encoding='latin-1')
            ...
            while True:
                ...
                print('received {} message from the client'.format(key_object.decrypt(data, padding=True)))
                if data:
